...
public class Quad implements IVertexProducer, IVertexConsumer {
     ...
     */
    public InterHelper reset(InterHelper helper, int s) {
        helper.reset(vertices[0].dx(s), vertices[0].dy(s), vertices[1].dx(s), vertices[1].dy(s),
                vertices[2].dx(s), vertices[2].dy(s), vertices[3].dx(s), vertices[3].dy(s)
        );
        return helper;
    }
    ...
    public static class Vertex {
        ...
        /**
         * Gets the 2d X cord for the given axis.
         *
         * @param s The axis. side >> 1
         * @return The x cord.
         */
        ...
        /**
         * Gets the 2d Y cord for the given axis.
         *
         * @param s The axis. side >> 1
         * @return The y cord.
         */
         ...
         *
         * @param interHelper The InterHelper to use.
         * @param others       The other Vertices to use as a template.
         * @return The same Vertex.
         */
        public Vertex interColorFrom(InterHelper interHelper, Vertex[] others) {
            for (int e = 0; e < 4; e++) {
                ...
                if (p1 != p2 || p2 != p3 || p3 != p4) {
                    color[e] = interHelper.interpolate(p1, p2, p3, p4);
                }
            }
            return this;
        }
         ...
         * @return The same Vertex.
         */
        public Vertex interUVFFrom(InterHelper interHelper, Vertex[] others) {
            for (int e = 0; e < 2; e++) {
                ...
                if (p1 != p2 || p2 != p3 || p3 != p4) {
                    uv[e] = interHelper.interpolate(p1, p2, p3, p4);
                }
            }
            return this;
        }
         ...
         * @return The same Vertex.
         */
        public Vertex interLightMapFrom(InterHelper interHelper, Vertex[] others) {
            for (int e = 0; e < 2; e++) {
                ...
                if (p1 != p2 || p2 != p3 || p3 != p4) {
                    lightmap[e] = interHelper.interpolate(p1, p2, p3, p4);
                }
            }
            return this;
        }
